...
import com.roadjourney.databinding.FragmentFindId1Binding

class FindId1Fragment : Fragment() {
    lateinit var binding: FragmentFindId1Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentFindId1Binding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCheckFilled.setOnClickListener {
            requireActivity().supportFragmentManager
                .beginTransaction()
                .replace(R.id.fcv_find_id, FindId2Fragment())
                .addToBackStack(null)
                .commit()
        }
    }
