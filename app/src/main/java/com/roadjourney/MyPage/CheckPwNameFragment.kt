...
import com.roadjourney.databinding.FragmentCheckPwNameBinding

class CheckPwNameFragment : Fragment() {
    lateinit var binding: FragmentCheckPwNameBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentCheckPwNameBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNextFilled.setOnClickListener {
            requireActivity().supportFragmentManager
                .beginTransaction()
                .replace(R.id.fcv_change_account, ChangeNameFragment())
                .addToBackStack(null)
                .commit()
        }
