...
import com.roadjourney.databinding.FragmentCheckPwEmailBinding

class CheckPwEmailFragment : Fragment() {
    lateinit var binding: FragmentCheckPwEmailBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentCheckPwEmailBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNextFilled.setOnClickListener {
            requireActivity().supportFragmentManager
                .beginTransaction()
                .replace(R.id.fcv_change_account, ChangeEmailFragment())
                .addToBackStack(null)
                .commit()
        }
